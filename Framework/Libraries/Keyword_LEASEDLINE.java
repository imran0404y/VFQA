...
public class Keyword_LEASEDLINE extends Driver {
	...
	public String LEASEDLINE() {
		...
		Result.fUpdateLog("------KEYMORD  Leased Line ------");
		try {
			...
			if (!(getdata("LL Node Features").equals(""))) {
				LL_Feature = getdata("LL Node Features");
			} else {
				LL_Feature = pulldata("LL Node Features");
			}

			if (!(getdata("LL Charges").equals(""))) {
				LL_Charges = getdata("LL Charges");
			} else {
				LL_Charges = pulldata("LL Charges");
			}

			if (!(getdata("Connection_LL Charges").equals("Connection_LL Charges"))) {
				LL_Charges_c = getdata("Connection_LL Charges");
			} else {
				LL_Charges_c = pulldata("Connection_LL Charges");
			}

			if (!(getdata("LL Features").equals(""))) {
				LL_Feature_c = getdata("LL Features");
			} else {
				LL_Feature_c = pulldata("LL Features");
			}
			...
			if (!(getdata("LL SLA").equals(""))) {
				LL_SLA = getdata("LL SLA");
			} else {
				LL_SLA = pulldata("LL SLA");
			}

			if (!(getdata("LL SLA2").equals(""))) {
				LL_SLA2 = getdata("LL SLA2");
			} else {
				LL_SLA2 = pulldata("LL SLA2");
			}
